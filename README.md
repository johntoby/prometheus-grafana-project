...
aws eks update-kubeconfig --name obacloud-eks-cluster --region us-east-2
...
official page: https://artifacthub.io/packages/helm/prometheus-community/kube-prometheus-stack 
...
helm show values prometheus-community/kube-prometheus-stack --version 65.5.1 > promvalue.yaml

helm install prometheus prometheus-community/kube-prometheus-stack -n monitoring --create-namespace -f promvalue.yaml 
...
k port-forward service/prometheus-kube-prometheus-prometheus -n monitoring 9090:9090 &
